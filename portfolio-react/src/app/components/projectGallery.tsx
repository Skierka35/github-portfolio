...
function ProjectCard({
  ...
  return (
    <div
      ...
      onClick={handleOpen}
    >
      <div className="overflow-hidden h-64 md:h-72 bg-black/5">
        {project.video ? (
          <video
            ref={videoRef}
            src={project.video}
      ...
      <div className="p-6">
        ...
        <p className="text-sm leading-relaxed text-slate-600 mb-5 text-justify">
          {description}
        </p>
...
function ProjectModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* LEFT: Gallery */}
        <div className="min-h-[320px] lg:min-h-0 border-b lg:border-b-0 lg:border-r border-black/10">
          <div className="relative w-full h-[46vh] lg:h-[90vh] max-h-[520px] lg:max-h-none bg-black/5">
            {project.video ? (
              <video
                src={project.video}
                controls
...
export default function Portfolio() {
  ...
  return (
    <section className="py-20 px-6 max-w-7xl mx-auto">
      <h1 className="text-4xl font-semibold text-center mb-4 text-slate-900">
        {heading}
      </h1>

      <p className="text-center mb-10 text-slate-600">{subtitle}</p>
